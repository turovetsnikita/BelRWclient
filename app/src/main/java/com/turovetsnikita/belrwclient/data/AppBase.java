...
public final class AppBase {
    ...
    public static final class RecentDirections implements BaseColumns {
        ...
        public final static String from_value = "from_value";
        public final static String from_exp = "from_exp";
        public final static String from_esr = "from_esr";
        public final static String to_value = "to_value";
        public final static String to_exp = "to_exp";
        public final static String to_esr = "to_esr";
    }
