...
public class RouteRVAdapter extends RecyclerView.Adapter<RouteRVAdapter.RouteViewHolder> {
    ...
    public static class RouteViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView cv;
        TextView trailer,station,stop_time,stop_date,dep_time,dep_date,stop_int;
        RouteViewHolder(View itemView) {
            super(itemView);
            cv = (CardView)itemView.findViewById(R.id.cv);
    ...
    public void onBindViewHolder(RouteViewHolder routeViewHolder, int i) {
        ...
        if (route.get(i).trailer_car.equals("")) routeViewHolder.trailer.setVisibility(View.GONE);
        else {
            routeViewHolder.trailer.setText(route.get(i).trailer_car);
            routeViewHolder.trailer.setVisibility(View.VISIBLE);
        }
